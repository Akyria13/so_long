...
/*   Updated: 2025/03/19 15:43:50 by jowagner         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sprite_init_env(t_so_long *so_long)
{
	...
	so_long->game.wall_s_02.ptr = mlx_xpm_file_to_image(so_long->mlx_v.mlx,
			Wall_S_F02, &so_long->game.wall_s_02.width,
			&so_long->game.wall_s_02.height);
	...
	if (!so_long->game.wall_s_01.ptr || !so_long->game.wall_s_02.ptr
		|| !so_long->game.grass_s_01.ptr)
	{
